...
<body>
	...
	<div class="container-fluid">
		...
		<c:if test="${data.getBannerUrl()==null}">
					<div class="row align-items-center logo-strip" style="background-image:url('./images/index.jpg')">
				</c:if>
				<c:if test="${data.getBannerUrl()!=null}">
					<div class="row align-items-center logo-strip" style="background-image:url('${data.getBannerUrl()}')">
				</c:if>
			...
			<div class="col-md-8">
				<div class="banner-text">
					...
					${data.getDistrict()},${data.getState()}
						-${data.getPinCode()}</h6>
				</div>
			</div>
			<div class="col-md-2">
	...
	<c:if test="${teacherSchoolId==null}">
		<c:redirect url="/" />
	</c:if>
